...
exports.fetchDatas = async (req, res) => {
    ...
    try {
        const { count, rows } = await RealisationModel.findAndCountAll({
            where: searchFilter,
            limit,
            offset,
            order: [['id', 'DESC']]
...
exports.fetchSigleData = async (req, res) => {
    try {
        const datas = await RealisationModel.findByPk(req.params.id);
...
exports.postData = async (req, res) => {
    ...
    try {
        if (!id || id === "") {
            ...
            // 🔸 Mise à jour
            const [updated] = await RealisationModel.update({ annee, titre, sousTitre, description }, { where: { id } });
            if (updated) {
...
exports.deleteData = async (req, res) => {
    try {
        const deleted = await RealisationModel.destroy({ where: { id: req.params.id } });
        if (deleted) {
