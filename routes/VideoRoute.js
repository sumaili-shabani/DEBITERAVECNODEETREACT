...
router.get('/check_status_video/:id', auth, VideoController.editStatus);

router.get('/fetch_video_data', VideoController.fetchDatas);
router.get('/fetch_video_pub', VideoController.fetchOneVideoPub);
