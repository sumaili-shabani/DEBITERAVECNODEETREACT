...
export default function RealisationPage() {
    ...
    const [listData, setDataList] = useState<UiRealisation[]>([]);
    const [formData, setFormData] = useState<Partial<UiRealisation>>({});
    ...
    const loadlistData = async () => {
        ...
        try {
            const res = await fetchItems<UiRealisation>('/fetch_realisation', {
                q: search,
                page: currentPage,
                limit,
            });
    ...
    */
    const handleEdit = async (id: number) => {
        const role = await fetchItem<UiRealisation>('/fetch_single_realisation', id);
    ...
    const handleDelete = async (id: number) => {
        ...
        if (confirmed) {
            try {
                await removeItem('/delete_realisation', id);
                loadlistData();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        await saveItem('/insert_realisation', formData);
        loadlistData();
        handleCloseModal();
    };
    ...
    const handlEditImage = async (id: number) => {
        const data = await fetchItem<UiRealisation>('/fetch_single_realisation', id);
    ...
    const handleSubmitImage = async (e: React.FormEvent) => {
        ...
        await saveItemImageForm('/edit_realisation_logo', formDataToSend);
        loadlistData();
    ...
    */
    ...
    return (
        <div className="mt-4">
            <h4 className="mb-3">Liste des réalisations</h4>
            {/* loading component */}
            <LoaderAndError
                loading={loading}
                error={error}
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <TextField
                                ...
                                placeholder="Titre de réalisation"
                                label="Titre de réalisation"
                        ...
                        <div className="col-md-12">
                            <TextAreaFild
                                ...
                                onChange={handleInputChange}
                                placeholder="Sous titre de réalisation"
                                label="Sous titre de réalisation"
                        ...
                        <div className="col-md-12">
                            <RichTextField
                                ...
                                onChange={handleInputChange}
                                placeholder="Description de réalisation"
                                label="Description de réalisation"
                                icon="fas fa-text-width"
                                required
                            />
                        </div>
