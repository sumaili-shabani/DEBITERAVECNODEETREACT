...
export default function ValeurPage() {
    ...
    const loadlistData = async () => {
        setLoading(true);
        try {
            const res = await fetchItems<UiValeur>('/fetch_valeur', {
                q: search,
                page: currentPage,
                limit,
            });
    ...
    */
    const handleEdit = async (id: number) => {
        const role = await fetchItem<UiValeur>('/fetch_single_valeur', id);
    ...
    const handleDelete = async (id: number) => {
        ...
        if (confirmed) {
            try {
                await removeItem('/delete_valeur', id);
                loadlistData();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        await saveItem('/insert_valeur', formData);
        loadlistData();
        handleCloseModal();
    };
